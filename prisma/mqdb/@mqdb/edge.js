...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\Code\\musiquiz\\prisma\\mqdb\\@mqdb",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
config.injectableEdgeEnv = () => ({
  parsed: {
    DATABASE_URL_MQ: typeof globalThis !== 'undefined' && globalThis['DATABASE_URL_MQ'] || typeof process !== 'undefined' && process.env && process.env.DATABASE_URL_MQ || undefined
  }
})
